...
Not all scripts on this page are fully functional. This list is for reference only. Use at your own risk.
  ...
  * [Add Translation Buttons](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-AddTranslationButtons.user.js) 2.3.4
  ...
  * [Base](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-Base.user.js) 2.8.3
    - basic functionality for WFES
  * [Click Enlarge Images](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-ClickEnlargeImages.user.js) 1.0.1
    - auto-click the enlarge images symbols (requires image mod script)
  * [Debug](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-Debug.user.js) 1.3.6
  ...
  * [image Mods](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-ImageMod.user.js) 1.4.0
  ...
  * [maps open in](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-OpenIn.user.js) 1.5.0
    - add "Open In" for maps
  * [ORCa](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-orca.user.js) 1.0.2
    - ORCa
  * [POI Submission Availability](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-PoiSubmissionData.user.js) 1.0.0
  ...
  * [Review Improve CSS](https://altertobi.github.io/Wayfarer-Extension-Scripts/dev/wfes-reviewImproveCSS.user.js) 1.2.2
